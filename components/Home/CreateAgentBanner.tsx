...
export default function CreateAgentBanner() {
    return (
        <View style={{ backgroundColor: Colors.PRIMARY, padding: 10, borderRadius: 10, display: "flex", flexDirection: "row", marginTop: 15, shadowColor: Colors.BLACK, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 10, elevation: 6 }}>
